...
import Logo from "../assets/CyclineLogo2.png" // Purple logo for light mode
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-primary/10 hover:bg-primary/20 text-primary p-2 rounded-full transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#services" className="text-foreground/70 hover:text-primary transition-colors duration-300">Services</a></li>
              <li><a href="#missions" className="text-foreground/70 hover:text-primary transition-colors duration-300">Nos Missions</a></li>
